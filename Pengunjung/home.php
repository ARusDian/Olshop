    ...
    <header>
        <div class = "head-wrap">
            <div class = "announcement">
                <a href="" class="btn announ">Jangan lewatkan, Ayo Bergabung!</a>
        ...
        <div class="container">
            <div class="head-bottom"> 
                ...
                <div class="header-right">
                    ...
                    <a href="product.php" ><span class="fa fa-shopping-cart" aria-hidden="true"></span>Produk</a>
                </div>
            </div>
        </div>
    </header>
    ...
    <div class="product-wrapper">
        <div class="container">
          <div class="head-product">
            <h1>Produk-Produk Terbaik Bulan Ini!</h1>
          </div>

          <div class="products">
          <?php
        include('../koneksi.php');
                $data = mysqli_query($koneksi,"SELECT * FROM barang LIMIT 4") or die(mysqli_connect_error($koneksi));
                $no = 1;
            ...
            <div class="product">
              ...
              <img src="../assets/images/product/<?=$row['gambar'] ;?>" height="150px" width="100%">
              </div>
